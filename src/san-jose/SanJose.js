    ...
    render() {
        return (
            <div className="SanJose">
                ...
                <br />
                <img src={sanjosea} alt="san-jose"
                    title="san-jose" className="img-responsive img-rounded center-block" />
                <br />
                <img src={sanjoseb} alt="san-jose"
                    title="san-jose" className="img-responsive img-rounded center-block" />
                <br />
                <img src={sanjosec} alt="san-jose"
                    title="san-jose" className="img-responsive img-rounded center-block" />
                <br />
                <img src={sanjosed} alt="san-jose"
                    title="san-jose" className="img-responsive img-rounded center-block" />
                <br />
